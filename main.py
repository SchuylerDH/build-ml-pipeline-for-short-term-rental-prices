...
def go(config: DictConfig):
    ...
    # Steps to execute
    steps_cfg = config["main"]["steps"]
    if isinstance(steps_cfg, str):
        active_steps = steps_cfg.split(",")
    else:
        active_steps = steps_cfg
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "basic_cleaning" in active_steps:
            _ = mlflow.run(
                    ...
                    "output_description": "Data_with_outliers_nd_null_values_removed",
        ...
        if "train_random_forest" in active_steps:
            ...
            rf_config_path = Path(rf_config).as_posix()
